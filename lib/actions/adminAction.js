...
exports.buildFormObject = buildFormObject;
...
function postObject(restUrl, restName, formName, object) {
  return function (dispatch) {
    dispatch(_rest2.default.actions.restPost({ url: restUrl, name: restName }, { body: (0, _stringify2.default)(buildFormObject(formName, object)) }));
  };
}

function putObject(restUrl, restName, formName, id, object) {
  return function (dispatch) {
    dispatch(_rest2.default.actions.restPut({ url: restUrl, name: restName, id: id }, { body: (0, _stringify2.default)(buildFormObject(formName, object)) }));
  };
}
...
function buildFormObject(formName, object) {
  var formObject = object;
  if (formName) {
    formObject = (0, _defineProperty3.default)({}, formName, object);
  }
  return formObject;
}
...
var _SchemaBuilder = require("./jsonSchemaForm/schema/SchemaBuilder");
...
var Pool = function () {
  ...
  (0, _createClass3.default)(Pool, [{
    ...
    key: "receiveRequestTransformer",
    value: function receiveRequestTransformer(request, pageType) {
      var data = request.data;
      data = this._adminConfig.receiveRequestTransformer(data, pageType);
      return (0, _extends3.default)({}, request, { data: data });
    }
  }, {
    key: "formRequestTransformer",
    value: function formRequestTransformer(request, pageType) {

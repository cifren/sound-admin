...
var EditPage = function (_React$Component) {
  ...
  (0, _createClass3.default)(EditPage, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (!(0, _lodash.isEqual)(this.props.adminObject, nextProps.adminObject)) {
        ...
        if (!nextProps.adminObject.data.errors) {
          ...
          var adminObject = (0, _lodash.isFunction)(this.props.pool.receiveRequestTransformer) ? this.props.pool.receiveRequestTransformer(nextProps.adminObject, "edit") : nextProps.adminObject;
    ...
    value: function onSubmit(data) {
      ...
      this.props.actions.putObject(this.props.pool.restUrl, this.props.pool.restName, this.props.pool.formName, this.props.params.id, this.props.pool.formRequestTransformer(data.formData, "edit"));
    }
  }, {
    key: "onDelete",
